...
export const defaultSocialMediaLinks = [
  {
    "type": "facebook",
...
export const defaultWorkingExperience = [
  {
    "company": "Highstock",
    "startDate": "2025-01-08T02:30:00.000Z",
    "position": "Founding Team Engineer",
    "description": "Engineer in founding team at Highstock, my work revolves around building a b2b marketplace for inventory liquidation"
  },
  {
    "description": "I worked on getting state of the art results for classifying autism from fMRI data on the ABIDE dataset. My worked revolved around Dimensionality Reduction using which I was able to get 80 percent classification accuracy, as compared to other state of the art results.",
    "endDate": "2020-08-15T12:30:00.000Z",
    "position": "Research Intern",
    "startDate": "2020-06-15T02:30:00.000Z",
    "company": "IIIT Allahabad"
  },
  {
    "company": "IIT Delhi",
    "description": "I was an intern for a period of two months. I worked on a project to create a system to track files in real time using barcodes and barcode scanners. We made a central web app based on Java and Struts. It was deployed on a VM instance on IIT Delhi’s ingenious cloud platform making it accessible locally, within the IIT network. Also, IIT Delhi’s OAuth system was added to increase the security of the app and make it accessible to everyone within the IIT network.",
    "position": "Intern",
    "startDate": "2019-06-11T02:30:00.000Z",
    "endDate": "2019-07-28T12:30:00.000Z"
  },
  {
    "company": "Paycrunch",
    "endDate": "2021-06-01T12:30:00.000Z",
    "startDate": "2021-04-08T02:30:00.000Z",
    "description": "My work involved integrating various API's to the PayCrunch mobile app.",
    "position": "Mobile Dev Intern"
  },
  {
    "position": "Full Stack Intern",
    "endDate": "2022-08-02T12:30:00.000Z",
    "startDate": "2021-06-01T02:30:00.000Z",
  ...
  },
  {
    ...
    "company": "Tezsure",
    "description": "My work involves developing the mobile wallet app on React Native for the blockchain currency Tez and building a Flutter based package to be able to interact with the Tezos Ecosystem.",
    "startDate": "2020-10-05T02:30:00.000Z",
    "position": "Flutter Intern"
  },
  {
    "description": "Built dynamic pricing systems (FMCG/Staples) and revamped Pharma category UX (25k+ buyers) for a B2B marketplace, improving user experience and driving sales. Developed a high-volume order processing service (90% accuracy, 15 min completion) and championed critical compliance projects, streamlining operations and ensuring business continuity. Led the migration of a legacy promotion system for scalability and tackled complex projects with minimal prior knowledge, demonstrating initiative and problem-solving skills.",
    "company": "Udaan",
    "endDate": "2024-12-31T12:30:00.000Z",
    "startDate": "2022-08-08T02:30:00.000Z",
...
export const defaultProjectsData = [
  {
    ...
    "projectTagline": "A bot that uses facebook auth to login and find matches on Tinder.",
    "projectTitle": "Tinder Bot",
    "id": 7
  },
  {
    "github": "https://github.com/dscbvppune/folio-app",
    "projectTagline": "Made a portfolio website for students to be able to update their portfolio from an app.",
    "id": 5,
    "projectTitle": "Folio"
  },
  {
    ...
    "id": 8,
    "projectTagline": "Built a machine learning model to classify patients having Heart diseases or not from given dataset."
  },
  {
  ...
  },
  {
    ...
    "projectTitle": "ScanQ",
    "projectTagline": "A smart attendance management system that reduces paperwork.",
    "id": 9
  },
  {
  ...
  },
  {
    ...
    "id": 3,
    "projectTagline": "Cats vs Dogs classifier based on Transfer Learning approach."
  },
  {
    "id": 0,
    "projectTagline": "Pen down your daily thoughts in your own personal journal!",
    "logoUrl": "https://ph-files.imgix.net/a93cca81-058b-487b-848e-20dcec49ff90.png?auto=format&w=256&h=256&fit=crop",
    "projectTitle": "Thoughts"
  },
  {
    "github": "https://github.com/dewanshrawat15/Jack",
    "projectTitle": "Jack",
    "projectTagline": "A mobile app using which you can control basic MacOS functions.",
    "id": 4
  },
  {
    "github": "https://github.com/dewanshrawat15/Alfred",
    "projectTagline": "A mobile app predicts the genres of TV Shows/Movies by their poster.",
    "id": 6,
    "projectTitle": "Alfred"
  }
];
